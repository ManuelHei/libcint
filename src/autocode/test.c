...
#include "c2f.h"
/* (i |X R12 R12 R12 |j) */
static void CINTgout2e_int2c2e_test(double *gout,
...
void int2c2e_test_optimizer(CINTOpt **opt, FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env) {
FINT ng[] = {0, 1, 0, 0, 1, 1, 1, 1};
CINTall_2c2e_optimizer(opt, ng, atm, natm, bas, nbas, env);
}
CACHE_SIZE_T int2c2e_test_cart(double *out, FINT *dims, FINT *shls,
...
envs.f_gout = &CINTgout2e_int2c2e_test;
envs.common_factor *= 1.0;
return CINT2c2e_drv(out, dims, &envs, opt, cache, &c2s_cart_1e);
} // int2c2e_test_cart
CACHE_SIZE_T int2c2e_test_sph(double *out, FINT *dims, FINT *shls,
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt, double *cache) {
FINT ng[] = {0, 1, 0, 0, 1, 1, 1, 1};
CINTEnvVars envs;
CINTinit_int2c2e_EnvVars(&envs, ng, shls, atm, natm, bas, nbas, env);
...
CACHE_SIZE_T int2c2e_test_spinor(double complex *out, FINT *dims, FINT *shls,
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt, double *cache) {
fprintf(stderr, "&c2s_sf_1e_spinor not implementedn");
return 0;
}
ALL_CINT(int2c2e_test)
ALL_CINT_FORTRAN_(int2c2e_test)
