...
(gen-cint "v_nuc_der.c"
  ...
  '("int1e_x0_nablarnuc"             ( x0 nabla \| nuc \| ))
  '("int1e_y0_nablarnuc"             ( y0 nabla \| nuc \| ))
  '("int1e_z0_nablarnuc"             ( z0 nabla \| nuc \| ))
  '("int1e_r0_nablarnuc"             ( r0 dot nabla \| nuc \| ))
...
(gen-cint "v_ee_der.c"
  ...
  ; '("int2e_20x0_nablar12"             ( x0 x0 x0 x0 x0 x0 x0 x0 x0 x0 \, \| nabla-r12 \| \, ))
...
;
  ...
  '("int1e_1_1_d1"             ( y0 py \| \| ))
  '("int1e_2_1_d2"             ( z0 pz \| \| ))
  '("int1e_0_2_d0"             ( x0 x0 px \| \| ))
  '("int1e_1_2_d1"             ( y0 y0 py \| \| ))
  '("int1e_2_2_d2"             ( z0 z0 pz \| \| ))
;
  '("int2e_0_0_d0_r12"        ( px \, \| r12 \| \, ))
  '("int2e_1_0_d1_r12"        ( py \, \| r12 \| \, ))
  '("int2e_2_0_d2_r12"        ( pz \, \| r12 \| \, ))
  '("int2e_0_1_d0_r12"        ( x0 px \, \| r12 \| \, ))
  '("int2e_1_1_d1_r12"        ( y0 py \, \| r12 \| \, ))
  '("int2e_2_1_d2_r12"        ( z0 pz \, \| r12 \| \, ))
  '("int2e_0_2_d0_r12"        ( x0 x0 px \, \| r12 \| \, ))
  '("int2e_1_2_d1_r12"        ( y0 y0 py \, \| r12 \| \, ))
  '("int2e_2_2_d2_r12"        ( z0 z0 pz \, \| r12 \| \, ))
;
  '("int2e_0_0_r12"           ( \, \| r12 \| \, ))
  '("int2e_1_0_r12"           ( \, \| r12 \| \, ))
  '("int2e_2_0_r12"           ( \, \| r12 \| \, ))
  '("int2e_0_1_r12"           ( x0 \, \| r12 \| \, ))
  '("int2e_1_1_r12"           ( y0 \, \| r12 \| \, ))
  '("int2e_2_1_r12"           ( z0 \, \| r12 \| \, ))
  '("int2e_0_2_r12"           ( x0 x0 \, \| r12 \| \, ))
  '("int2e_1_2_r12"           ( y0 y0 \, \| r12 \| \, ))
  '("int2e_2_2_r12"           ( z0 z0 \, \| r12 \| \, ))
;
  '("int1e_0_0_d0_nuc"        ( px \| nuc \| ))
  '("int1e_1_0_d1_nuc"        ( py \| nuc \| ))
  '("int1e_2_0_d2_nuc"        ( pz \| nuc \| ))
  '("int1e_0_1_d0_nuc"        ( x0 px \| nuc \| ))
  '("int1e_1_1_d1_nuc"        ( y0 py \| nuc \| ))
  '("int1e_2_1_d2_nuc"        ( z0 pz \| nuc \| ))
  '("int1e_0_2_d0_nuc"        ( x0 x0 px \| nuc \| ))
  '("int1e_1_2_d1_nuc"        ( y0 y0 py \| nuc \| ))
  '("int1e_2_2_d2_nuc"        ( z0 z0 pz \| nuc \| ))
;
  '("int1e_0_0_nuc"           ( \| nuc \| ))
  '("int1e_1_0_nuc"           ( \| nuc \| ))
  '("int1e_2_0_nuc"           ( \| nuc \| ))
  '("int1e_0_1_nuc"           ( x0 \| nuc \| ))
  '("int1e_1_1_nuc"           ( y0 \| nuc \| ))
  '("int1e_2_1_nuc"           ( z0 \| nuc \| ))
  '("int1e_0_2_nuc"           ( x0 x0 \| nuc \| ))
  '("int1e_1_2_nuc"           ( y0 y0 \| nuc \| ))
  '("int1e_2_2_nuc"           ( z0 z0 \| nuc \| ))
)
